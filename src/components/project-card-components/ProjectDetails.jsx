    ...
    return (
        <>
            <div className="w-full flex flex-col justify-between items-center px-6 custom-sm:px-9 text-center relative">
                ...
                <div className={`w-9 h-9 ${props.source != 0 ? 'flex' : 'hidden'} flex-col justify-center items-center absolute top-3 right-[2px] custom-sm:right-2 
                bg-white hover:bg-gradient-to-tr from-gradient-blue to-gradient-purple border-white border-[0.5px] border-dashed rounded-full`}>
                    <div className="w-7 h-7 flex flex-col justify-center items-center bg-white rounded-full">
